#Create a dictionary with name and mobile number. Define a GUI interface using tkinter and pack the label and create a scrollbar to scroll the list of keys in the dictionary.
import tkinter
from tkinter import *
tk=Tk()
tk.title("GUI")
data={'sonali':'9760993285','antra':'72184974790','simran':'78985875768','himadri':'9126675432'}
...
#In the same tkinter file as above,create a function to insert items into the dictionary.
import tkinter
from tkinter import *
tk=tkinter.Tk()
tk.title("details")
...
a={'sonali':9760993285,'antra':72184974790,'simran':78985875768,'himadri':9126675432}
